        ...
        <card shadow class="card-profile mt--300" no-body>
          <div class="px-4">
              ...
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <div
                      v-if="
                        this.$store.state.accounts.userid.slice(0, 1) === 't'
                      "
                    >
                      <img
                        :src="
                          `data:image/png;base64,${userInfo['profile_url']}`
                        "
            ...
            <div class="text-center mt-5">
              ...
              <div class="contactInfo">
                ...
                <div class="h6 font-weight-300">
                  <i class="ni mr-2"></i> {{ userInfo["email"] }}
                </div>
                <div class="h6">
            ...
            <div
              ...
              v-if="this.$store.state.accounts.userid.slice(0, 1) === 't'"
            >
              <div class="row justify-content-center">
                <div class="col-lg-9">
                  <h4>전문분야</h4>
            ...
            <div class="col-lg-12 text-center my-4">
              <router-link to="/update">
                <base-button type="default">회원정보 수정</base-button>
              </router-link>
            </div>
...
export default {
  ...
  created() {
    console.log("프로필 페이지");
    axios({
      url: `https://i7a606.q.ssafy.io/service-api/user/${
